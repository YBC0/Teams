...
const Index = () => {
  ...
  const content = {
    ...
    hero: {
      ...
      intro: language === 'da' ? 'Team SEA er en dansk forening, der hjælper mennesker i nød. Vi bygger brønde og skaber håb – én donation ad gangen.' : 'Team SEA is a Danish non-profit helping people in need. We build wells and bring hope – one donation at a time.'
    },
    cta: {
    ...
    impact: {
      ...
      description: language === 'da' ? 'Se hvad vi allerede har opnået sammen med jeres støtte. Hver donation gør en forskel.' : "See what we've already accomplished with your support. Every donation makes a difference.",
        ...
        <div className="container-custom">
          <div className="grid md:grid-cols-2 gap-8">
            <div className="rounded-xl overflow-hidden shadow-lg animate-slide-up order-2 md:order-1">
              <img src="https://images.unsplash.com/photo-1532629345422-7515f3d16bb6?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80" alt={language === 'da' ? 'Donér til Team SEA' : 'Donate to Team SEA'} className="w-full h-full object-cover" />
            </div>
            <div className="flex flex-col justify-center animate-slide-up order-1 md:order-2">
              ...
              <p className="mb-6">
                {language === 'da' ? "Donér via MobilePay. Husk at skrive dit ønskede navn i beskedfeltet – eller skriv 'Anonym'." : "Donate via MobilePay. Please write your preferred name in the message field – or write 'Anonymous'."}
              </p>
              <Button asChild>
